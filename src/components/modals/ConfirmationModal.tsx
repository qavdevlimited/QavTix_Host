        ...
        <AnimatedDialog open={isOpen} showCloseButton={false} className='md:max-w-sm!'>
            ...
            <DialogFooter className="px-6 mt-6 flex-row gap-3 sm:gap-3">
                <button
                    ...
                    className="flex-1 px-6 py-3 text-sm font-medium text-brand-secondary-9 bg-white border-2 border-gray-300 rounded-full hover:bg-brand-neutral-100 transition-all"
                >
                    {cancelText}
                </button>
                <button
                    onClick={handleConfirm}
                    className="flex-1 px-6 py-3 text-sm font-medium text-white bg-brand-primary-6 rounded-full hover:bg-brand-primary-7 hover:shadow-md transition-all"
                >
                    {confirmText}
                </button>
            </DialogFooter>
