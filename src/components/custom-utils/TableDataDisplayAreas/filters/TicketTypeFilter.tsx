                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isSelected
                                        ? 'border-primary-6 bg-linear-to-br from-primary-1 to-primary-2 shadow-md'
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    <p className={cn('font-semibold', isSelected ? 'text-primary-8' : 'text-secondary-9')}>
                                        {type.label}
                                    </p>
                                    <p className="text-sm text-neutral-6">{type.description}</p>
                                </div>
                                {isSelected && (
