...
import { liveEventActions } from "../../dropdown/resources/live-events-actions"
                    ...
                    <table className="w-full">
                        ...
                        <tbody className="divide-y divide-neutral-5 bg-white">
                            {pagination.currentItems.map((event) => {
                                ...
                                const status = liveEventsStatusConfig["selling-fast" as keyof typeof liveEventsStatusConfig] || liveEventsStatusConfig["selling-fast"]
