                                    ...
                                    >
                                        ...
                                        <td className="py-4 px-5">
                                            <div className="flex items-center gap-1 whitespace-nowrap">
                                                <Icon icon="mdi:circle" className={cn('w-2 h-2 text-secondary-7')} />
                                                <span className={cn('text-xs font-medium text-secondary-7')}>
                                                    Cancelled
                                                </span>
                                            </div>
                                        </td>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center justify-between text-xs pb-2 border-b border-neutral-2">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex items-center gap-1 whitespace-nowrap">
                                            <Icon icon="mdi:circle" className={cn('w-2 h-2 text-secondary-7')} />
                                            <span className={cn('text-[11px] font-medium text-secondary-7')}>
                                                Cancelled
                                            </span>
                                        </div>
                                    </div>
