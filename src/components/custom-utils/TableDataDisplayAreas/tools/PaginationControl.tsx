...
export default function PaginationControls({
    ...
    const itemsPerPage = endIndex - startIndex + 1
    const currentPage = propCurrentPage || Math.ceil(endIndex / itemsPerPage)
                    ...
                    {pageNumbers.map((page, index) => {
                        ...
                        return (
                            <span
                                key={pageNum}
                                className={cn(
                                    "min-w-9 h-9 px-3 rounded-md text-xs font-medium flex items-center justify-center",
                                    isActive
