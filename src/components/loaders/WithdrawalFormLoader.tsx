    ...
    return (
        <div className="w-full max-w-md mx-auto space-y-8 p-4">
            ...
            <div className="flex items-center gap-4 py-2 border-b border-neutral-2">
                <Skeleton className="h-6 w-6 bg-neutral-3" />
                <Skeleton className="h-8 flex-1 bg-neutral-2" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                <Skeleton 
                    key={i} 
                    className="h-12 w-full rounded-xl bg-neutral-2" 
                />
                ))}
            </div>

            <div className="space-y-3">
                <Skeleton className="h-4 w-40 bg-neutral-3" />
                <div className="p-4 border border-neutral-2 rounded-xl flex justify-between items-center">
                <Skeleton className="h-5 w-32 bg-neutral-2" />
                <Skeleton className="h-4 w-4 bg-neutral-3" />
                </div>
            </div>

            <Skeleton className="h-14 w-full rounded-xl bg-primary-2 shadow-sm" />
        </div>
    )
}